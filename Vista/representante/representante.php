...
$form.='<td><input id="num" type="text" class="cajasdetexto" onkeypress="return solonumeros(event)" onpaste="return false" name="cedula" maxlenght="9" pattern="[0-9]{5,}" title="Por favor rellenar con el formato correcto. Si es pasaporte solo colocar los números" required></td>';
$form.='</tr>';
$form.='<tr>';
$form.='<td>Nombre:</td>';
...
$form.='<td><input id="num2" type="text" name="cedula_a" class="cajasdetexto" onkeypress="return solonumeros(event)" onpaste="return false" pattern="[0-9]{5,}" title="Por favor rellenar con el formato correcto. Si es pasaporte solo colocar los números" required></td>';
$form.='</tr>';
$form.='<tr>';
