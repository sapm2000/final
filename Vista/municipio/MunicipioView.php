<?php
	...
	{
		header('Location: ../../Controlador/CtrlMunicipio.php?accion=buscatodos&pag=1&reg=10');
	}
	...
	$cat='';
	{
		...
		$form.='<td> <a href="MunicipioView1.php?accion=actualizar"><input type="button" class="botonmodal" value="Municipios Inactivos" title="Municipios Inactivos"> </a></td>';
		$form.= "</tr>";
		$form.= "</table>";
		$form.= "<br>";
		...
		$cat.= "</thead>";
		$cat.= "<tbody>";
		$datos = $_SESSION['catamuni'];
		foreach($datos as $d)
		{
	
			$cat.= "<tr>";
			$cat.= "<td>".$d['descrips']."</td>";
			$cat.= "<td><a href='../../Controlador/CtrlMunicipio.php?accion=buscaid&id=".$d['id']."'>";
			$cat.= "<img src='../imagenes1/editar.png' width='15px' hegiht='15px' title='Editar'></a></td>";
			$cat.= "<td><a href='../../Controlador/CtrlMunicipio.php?accion=eliminar&id=".$d['id']."'>";
