...
$form.='<tr>';
$form.='<td>Pais:</td>';
$form.='<td><input id="letra" type="text" class="cajasdetexto" value="'.$pai.'" onkeypress="return soloLetras(event)" name="pais" onpaste="return false" pattern="[A-Z a-z ]{2,15}" required></td>';
$form.='</tr>';
$form.='<tr>';
$form.='<td>Estado:</td>';
$form.='<td><input id="letras" type="text" name="estado" class="cajasdetexto" value="'.$est.'" maxlenght="9" onkeypress="return soloLetras(event)" onpaste="return false" pattern="[A-Z a-z ]{2,15}" required></td>';
$form.='</tr>';
$form.='<tr>';
$form.='<td>Ciudad:</td>';
$form.='<td><input type="text" name="ciudad" class="cajasdetexto" onkeypress="return soloLetras(event)" value="'.$ciu.'" onpaste="return false" pattern="[A-Z a-z ]{2,15}" required></td>';
$form.='</tr>';
$form.='<tr>';
