...
$_SESSION['titulo']='Reporte de los Atletas Filtrado por el Número de Telefóno';
$form='';
$cata='';
$boton='';
...
$form.='<td><input  type="text" class="cajasdetexto"  name="primer" pattern="([0]{1})([2,4]{1})([1-9]{2})*"></td>';
