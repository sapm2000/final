...
if($_GET['accion']=='ver_detalles') {
	...
	$form.='<td><input id="" type="text" name="direccion1" value="'.$dir1.'" class="cajasdetexto"></td>';
	$form.='</tr>';
	$form.="<tr>";
	...
	$form.='<tr>';
	$form.='<td> <input type="submit" value="Siguiente" id="submit" name="Registro_medicos"> </td>';
	$form.='</tr>';
	$form.='</table>';
