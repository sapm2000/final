...
{
	header("Location: ../../Controlador/AtletaController.php?accion=buscafiltrosdiscapacidad");
}
...
if($_GET['accion']=="actual"&&!empty($_SESSION['discapacidad']))
{
	...
	$reporte.="<tr><th>Nacionalidad</th><th>Cédula</th><th>Nombre</th><th>Apellido</th><th>Discapacidad</th></tr>";
	...
	foreach($catalogo as $cat)
	{
		...
		$reporte.="<td>".$cat['discapacidad']."</td>";	
...
if (empty($_SESSION['discapacidad'])) {
