...
$form.='<td><input  type="text" class="cajasdetexto"  name="primer" pattern="[A-Z a-z Ññ/s 0-9]{1}" title="Solo un dígito" onkeypress="return solonumeros(event)" onpaste="return false" required></td>';
