...
$form.='<td><input  type="text" class="cajasdetexto"  name="primer" pattern="[A-Z a-z 1-9]{1}" title="Solo un dígito" onkeypress="return solonumeros(event)" onpaste="return false" required></td>';
