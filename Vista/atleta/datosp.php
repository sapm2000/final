...
$form.='<td>'.$nac.'<input id="" type="text" name="cedula" class="cajasdetexto" maxlenght="9" onkeypress="return solonumeros(event)" onpaste="return false" pattern="[0-9]{3,}" title="Por favor rellenar con el formato correcto" required></td>';
$form.='</tr>';
$form.='<tr>';
$form.='<td>Nombres:</td>';
...
$nac.= "</select>";
	...
	$form.="<tr>";
	$form.='<td>Documento de Identidad:</td>';
	$form.='<td>'.$nac.'<input id="" type="text" name="cedula" value="'.$ced.'" class="cajasdetexto" maxlenght="9" onkeypress="return solonumeros(event)" onpaste="return false" pattern="[0-9]{5,}" title="Por favor rellenar con el formato correcto. Si es pasaporte solo colocar los números" required></td>';
	$form.='</tr>';
	$form.='<tr>';
	$form.='<td>Nombres:</td>';
