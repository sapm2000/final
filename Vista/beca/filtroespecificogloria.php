...
$_SESSION['titulo']='Reporte Especifico de Becas Gloriosas por Fecha';
$form='';
$cata='';
$boton='';
$form.='<form name="atleta" method="post" action="../../Controlador/BecaController.php?accion=filtroespecificogloria">';
$form.='<table>';
$form.='<tr>';
...
(
	'PERFIL' => $perfil,
	'TITULO'=>'Filtrar Becas Gloriosas por Fecha',
	'CATALOGO'=>$cata,
	'BOTONREG'=>$boton,
	'FORMULARIO'=>$form, 	
	'MENU'=>$_SESSION['menu']
