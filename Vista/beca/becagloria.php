...
if(empty($_SESSION['nombre']))
	...
	{
		header("Location: ../../Controlador/BecaController.php?accion=buscatodos111");
	}
...
$form.='</tr>';
$form.='<tr>';
$form.='<td>Fecha a Pagar (yyyy-mm-dd):</td>';
...
if($_GET['accion']=="actual" && !empty($_SESSION['catabeca100']))
{
