...
{
	header("Location: ../../Controlador/DisciplinaController.php?accion=buscatodos");
}
...
if($_GET['accion']=="actual" && !empty($_SESSION['catadisci']))
{
	$catalogo = $_SESSION['catadisci'];
	$cata.="<form name='catalog' action='../../Controlador/DisciplinaController.php?accion=registrar' method='post'>";
	$cata.="<table class=tabla-cat id=tabla>";
	$cata.="<tr><th>Disciplinas</th><th colspan='2'>Opción</th></tr>";
	foreach($catalogo as $cat)
	{
		$cata.="<tr>";	
		$cata.="<td>".$cat['disciplina']."</td>";	
		$cata.="<td><a href='../../Controlador/DisciplinaController.php?accion=seleccionar&id=".$cat['id']."'>";	
		$cata.="<img src='../imagenes1/editar.png' width='15px' height='15px' title='Editar'></a></td>";
		$cata.="<td><a href='../../Controlador/DisciplinaController.php?accion=eliminar&id=".$cat['id']."'>";	
