...
$form.='<tr>';
$form.='<td>Talla:</td>';
$form.='<td><input id="searchTerm" type="text" class="cajasdetexto" onkeyup="doSearch()" id="letra" onkeypress="return soloLetras(event)" onpaste="return false" name="tal" maxlenght="9" pattern="[a-z A-Z]{1}" required></td>';
$form.='</tr>';
$form.='</table>';
