...
$parroquia.= "</select>";
	...
	$cata.="</tr>";
	$cata.="<tr>";
	$cata.="<td>Fecha de Inicio (yyyy-mm-dd):</td>";
	$cata.="<td><input type='text' name='fecha_inicio' class='date' maxlenght='9'  id='fecha1' onblur='valFechas()' value='".$fei."'  pattern='([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01]))' max='".date("Y-m-d")."' onkeypress='return solonumerosguion(event)' onpaste='return false' required></td>";
	$cata.="</tr>";
	$cata.="<tr>";
	$cata.="<td>Fecha de Cierre (yyyy-mm-dd):</td>";
	$cata.="<td><input type='text' name='fecha_cierre' class='date' maxlenght='9' id='fecha2' onblur='valFechas()' value='".$fec."'  pattern='([12]\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01]))' max='".date("Y-m-d")."' onkeypress='return solonumerosguion(event)' onpaste='return false' required></td>";
	$cata.="</tr>";
	$cata.="<tr>";
